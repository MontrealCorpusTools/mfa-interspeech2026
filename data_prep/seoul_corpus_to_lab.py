...
benchmark_directory = Path(r"D:\Data\speech\benchmark_datasets\seoul_corpus")

if __name__ == "__main__":
    config.CLEAN = True
    corpus_path = benchmark_directory.joinpath("seoul_corpus_benchmark")
    reference_path = benchmark_directory.joinpath("seoul_reference_alignments")
    lab_directory = benchmark_directory.joinpath("seoul_corpus_lab")
    lab_reference_directory = benchmark_directory.joinpath("seoul_corpus_lab_reference")
    dictionary_path = validate_dictionary(None, None, "korean_mfa")
