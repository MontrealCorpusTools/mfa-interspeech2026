...
benchmark_directory = Path(r"D:\Data\speech\benchmark_datasets\buckeye")

if __name__ == "__main__":
    config.CLEAN = True
    corpus_path = benchmark_directory.joinpath("buckeye_corpus_benchmark")
    lab_directory = benchmark_directory.joinpath("buckeye_corpus_lab")
    lab_reference_directory = benchmark_directory.joinpath("buckeye_corpus_lab_reference")
    dictionary_path = validate_dictionary(None, None, "english_us_arpa")
    corpus = AcousticCorpusWithPronunciations(
        corpus_directory=corpus_path, dictionary_path=dictionary_path
    )
