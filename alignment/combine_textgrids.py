...
output_dir = r"D:\Data\experiments\interspeech_benchmarking\temp\combined"
        ...
        for speaker in os.listdir(reference_directory):
            ...
            for f in os.listdir(speaker_dir):
                ...
                for e in os.listdir(corpus_alignment_directory):
                    if e in ["mfa_3.1", "mfa_3.1_finetune", "mfa_3.1_adapted_finetune", "arpa_3.0", "arpa_3.0_finetune", "arpa_3.0_adapted_finetune"]:
                        continue
